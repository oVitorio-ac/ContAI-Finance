...
- [Diagrama DrawIO](docs/architecture-diagram.drawio) - Formato DrawIO
- [Diagramas Mermaid](docs/architecture-mermaid.md) - Diagramas Mermaid
- [Documentação Técnica](docs/technical-documentation.md) - Documentação completa

## 💰 Custos de Implementação AWS

**Estimativa**: $100-125 USD/mês para 50 usuários

- [Análise Completa de Custos](docs/aws-cost-analysis.md) - Análise detalhada por serviço
- [Resumo Executivo](docs/cost-summary.md) - Visão rápida e ROI
