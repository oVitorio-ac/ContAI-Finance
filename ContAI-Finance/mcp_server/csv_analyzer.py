...
class CSVAnalyzer:
    ...
    def _analyze_financial_data(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        for col in df.columns:
            if any(keyword in col.lower() for keyword in ['valor', 'preco', 'price', 'amount', 'total', 'saldo']):
    ...
    def query_data(self, filename: str, query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if "total" in query_lower or "soma" in query_lower:
                ...
                return {"message": "Consulta não reconhecida. Tente: total, média, maior, menor, positivos, negativos"}
    ...
    def _filter_positive_values(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        for col in numeric_cols:
            ...
            positive_data[col] = {
                ...
                "average": float(positive_df[col].mean()) if len(positive_df) > 0 else 0
            }
    ...
    def _filter_negative_values(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        for col in numeric_cols:
            ...
            negative_data[col] = {
                ...
                "average": float(negative_df[col].mean()) if len(negative_df) > 0 else 0
            }
